...
namespace HIS_Entity.ClinicManage
{
    ...
    public class MedicalCaseFeeInfo
    {
        ...
        private Decimal 检查用一次性医用材料1;
        /// <summary>
        /// 检查用一次性医用材料费-
        /// </summary>
        public Decimal 检查用一次性医用材料
        {
            get { return 检查用一次性医用材料1; }
            set { 检查用一次性医用材料1 = value; }
        }

        private Decimal 治疗用一次性医用材料1;
        /// <summary>
        /// 治疗用一次性医用材料费-
        /// </summary>
        public Decimal 治疗用一次性医用材料
        {
            get { return 治疗用一次性医用材料1; }
            set { 治疗用一次性医用材料1 = value; }
        }

        private Decimal 手术用一次性医用材料1;
        /// <summary>
        /// 手术用一次性医用材料费-
        /// </summary>
        public Decimal 手术用一次性医用材料
        {
            get { return 手术用一次性医用材料1; }
            set { 手术用一次性医用材料1 = value; }
        }
