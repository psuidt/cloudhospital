...
namespace HIS_Entity.IPManage
{
    ...
    public class IP_FeeItemRecord : AbstractEntity
    {
        ...
        private int _presnurseid;
        /// <summary>
        /// 划价或发送护士代码
        /// </summary>
        [Column(FieldName = "PresNurseID", DataKey = false, Match = "", IsInsert = true)]
        public int PresNurseID
        {
            get { return _presnurseid; }
            set { _presnurseid = value; }
        }
