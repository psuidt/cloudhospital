...
namespace HIS_MaterialManager.ObjectModel.Bill
{
    ...
    public interface IMwBill
    {
        ...
        /// <returns>单据结果</returns>
        MWBillResult AuditBill(int headID, int auditEmpID, string auditEmpName);
        ...
        void WriteAccount<THead, TDetail>(THead billHead, TDetail billDetails, MWStoreResult storeResult);
