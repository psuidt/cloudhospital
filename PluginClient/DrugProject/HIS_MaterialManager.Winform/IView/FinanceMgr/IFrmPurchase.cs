...
namespace HIS_MaterialManage.Winform.IView
{
    /// <summary>
    /// 采购计划接口
    /// </summary>
    interface IFrmPurchase : IBaseView
    {
        ...
        void InsertLessLowerLimitData(DataTable dtRtn);

        /// <summary>
        /// 插入低于上限的药品数据
        /// </summary>
        /// <param name="dtRtn">药品数据</param>
        void InsertLessUpperLimitData(DataTable dtRtn);
    }
}
