...
namespace HIS_MaterialManage.Winform.ViewForm
{
    ...
    /// 库存上下线
    /// </summary>
    public partial class FrmSetLimits : BaseFormBusiness, IFrmSetLimits
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        private bool CheckData()
        {
            ...
            int errRow = -1;
            bool rtn = CheckDetails(dtDetails, null, new string[1] { "MaterialID" }, out errMsg, out errCol, out errRow);
            if (!rtn)
            {
        ...
        {
            dgLimit.Columns["MaterialID"].ReadOnly = true;
            dgLimit.Columns["CenterMatName"].ReadOnly = true;
        ...
        /// 绑定物资选择卡片
        /// </summary>
        /// <param name="dtMaterial">物资信息</param>
        public void BindMaterialSelectCard(DataTable dtMaterial)
        {
            txt_Code.DisplayField = "CenterMatName";
            txt_Code.MemberField = "MaterialID";
            txt_Code.CardColumn = "MaterialID|编码|55,CenterMatName|名称|240,Spec|规格|220,ProductName|生产厂家|200,UnitName|单位|40";
            txt_Code.QueryFieldsString = "CenterMatName,MatName,PYCode,WBCode,TPYCode,TWBCode";
            txt_Code.ShowCardWidth = 800;
            txt_Code.ShowCardDataSource = dtMaterial;
        }
        ...
        public Dictionary<string, string> GetQueryCondition()
        {
            ...
            {
                queryCondition.Add("a.MaterialID", txt_Code.MemberValue.ToString());//物资ID
            }
            ...
            {
                queryCondition.Add(string.Empty, "(IsNull(a.UpperLimit,0)<=0 )");//物资ID
            }
        ...
        private void FrmSetLimit_OpenWindowBefore(object sender, EventArgs e)
        {
            ...
            //获取物资数据
            InvokeController("GetMaterialShowCardInfo", frmName);
            //查询库存数据
            InvokeController("GetStoreLimitData", frmName);
        }
        ...
        private void btn_Setting_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBoxEx.Show("没有查询到物资信息，不能进行设置");
                return;
            }
            //设置按钮状态
        ...
        /// <param name="jumpStop">终止标志</param>
