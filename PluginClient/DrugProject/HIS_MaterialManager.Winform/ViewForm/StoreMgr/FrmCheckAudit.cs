...
namespace HIS_MaterialManage.Winform.ViewForm
{
    ...
    /// 盘点审核
    /// </summary>
    public partial class FrmCheckAudit : BaseFormBusiness, IFrmCheckAudit
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public FrmCheckAudit()
        {
            InitializeComponent();
        }
        ...
        public void BindMaterialDept(DataTable dtDrugDept)
        {
            if (dtDrugDept != null)
            {
        ...
        public void BindDrugPositFindCard(DataTable dtDrugInfo)
        {
            ...
            txtCode.CardColumn = "MaterialID|编码|55,CenterMatName|名称|200,BatchNO|批次|70,Spec|规格|120,ProductName|生产厂家|120,UnitName|单位|40";
            txtCode.QueryFieldsString = "CenterMatName,AliasName,PYCode,WBCode,TPYCode,TWBCode";
            txtCode.ShowCardWidth = 600;
            txtCode.ShowCardDataSource = dtDrugInfo;
            //已审核明细定位ShowCard
            txtAuditCode.DisplayField = "CenterMatName";
            txtAuditCode.MemberField = "MaterialID";
            txtAuditCode.CardColumn = "MaterialID|编码|55,CenterMatName|名称|200,BatchNO|批次|70,Spec|规格|120,ProductName|生产厂家|120,UnitName|单位|40";
            txtAuditCode.QueryFieldsString = "CenterMatName,AliasName,PYCode,WBCode,TPYCode,TWBCode";
            txtAuditCode.ShowCardWidth = 600;
        ...
        public Dictionary<string, string> GetAuditHeadQueryCondition()
        {
            ...
            queryCondition.Add(
                string.Empty,
                "AuditTime between '" +
                dtpAuditDate.Bdate.Value.ToString("yyyy-MM-dd 00:00:00") +
                "' and '" +
                dtpAuditDate.Edate.Value.ToString("yyyy-MM-dd 23:59:59") +
                "'");
        ...
        private void txtCode_AfterSelectedRow(object sender, object selectedValue)
        {
            ...
            if (selectedValue != null)
            {
                ...
                for (int index = 0; index < dtDetails.Rows.Count; index++)
                {
                    ...
                    {
                        dgDetail.CurrentCell = dgDetail["NotBatchNo", index];
                        break;
                    }
        ...
        private void txtAuditCode_AfterSelectedRow(object sender, object selectedValue)
        {
            ...
            if (selectedValue != null)
            {
                ...
                for (int index = 0; index < dtDetails.Rows.Count; index++)
                {
                    ...
                    if (currentRow["MaterialID"].ToString() == materialId && currentRow["BatchNO"].ToString() == batchNo)
                    {
                        dgAuditDetail.CurrentCell = dgAuditDetail["AuditBatchNo", index];
                        break;
                    }
                    else
                    {
