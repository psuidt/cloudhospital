...
namespace HIS_MaterialManage.Winform.ViewForm
{
    ...
    /// 分类流水账
    /// </summary>
    public partial class FrmGoodsSortBill : BaseFormBusiness, IFrmGoodsSortBill
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public FrmGoodsSortBill()
        {
            InitializeComponent();
        }
        ...
        public void BindDgData(DataTable dt)
        {
            ...
            GridReport gridreport = ReportTool.GetReport((InvokeController("this") as AbstractController).LoginUserInfo.WorkId, 5008, 0, myDictionary, dt);
                ...
                switch (LogicType.SelectedValue.ToString())
                {
                    ...
                    case "213":
                        ...
                        if (cmb_dept.SelectedValue != null)
                        {
                            ...
                            {
                                queryCondition.Add("b.SupplierID", cmb_dept.SelectedValue.ToString());
                            }
                        }
        ...
        private void FrmGoodsSortBill_OpenWindowBefore(object sender, EventArgs e)
        {
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            if (LogicType.SelectedValue != null)
            {
                switch (LogicType.SelectedValue.ToString())
                {
                    ...
                    case "212":
                    case "213":
                        InvokeController("GetInStores", frmName, txtType.Tag);
                        break;
                    ///内耗出库、报损出库
                    case "222":
                    case "223":
                    case "224":
                        InvokeController("GetOutStores", frmName, txtType.Tag);
                        break;
                    ///盘点
                    case "242":
                        InvokeController("GetChecks", frmName, txtType.Tag);
                        break;
                    ///调价
                    case "251":
                        InvokeController("GetAdjPrices", frmName, txtType.Tag);
                        break;
                    default:
                        cmb_dept.DataSource = null;
                        break;
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            myDictionary.Add("查询人", currentUserName);
            myDictionary.Add("查询时间", DateTime.Now);
            ReportTool.GetReport((InvokeController("this") as AbstractController).LoginUserInfo.WorkId, 5008, 0, myDictionary, PrintDt).PrintPreview(true);
        }
