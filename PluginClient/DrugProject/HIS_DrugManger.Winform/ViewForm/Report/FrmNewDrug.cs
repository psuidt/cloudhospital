...
namespace HIS_DrugManage.Winform.ViewForm
{
    ...
    /// 新药入库统计
    /// </summary>
    public partial class FrmNewDrug : BaseFormBusiness, IFrmNewDrug
    {
        /// <summary>
        /// 构造参数
        /// </summary>
        ...
        public void BindGridData(DataTable dt)
        {
            ...
            GridReport gridreport = ReportTool.GetReport((InvokeController("this") as AbstractController).LoginUserInfo.WorkId, (int)DGEnum.PrintReport.新药统计, 0, myDictionary, dt);
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            InvokeController("GetNewDrug", deptId, yearMonth, drugName);
        }
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            myDictionary.Add("查询人", currentUserName);
            myDictionary.Add("查询时间", DateTime.Now);
            ReportTool.GetReport((InvokeController("this") as AbstractController).LoginUserInfo.WorkId, (int)DGEnum.PrintReport.新药统计, 0, myDictionary, PrintDt).PrintPreview(true);
        }
        ...
        /// <param name="sender">对象</param>
        /// <param name="e">参数</param>
        private void FrmNewDrug_OpenWindowBefore(object sender, EventArgs e)
        {
