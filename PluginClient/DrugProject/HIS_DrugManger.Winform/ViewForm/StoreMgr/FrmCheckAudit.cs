...
namespace HIS_DrugManage.Winform.ViewForm
{
    ...
    public partial class FrmCheckAudit : BaseFormBusiness, IFrmCheckAudit
    {
        ...
        public void BindDrugPositFindCard(DataTable dtDrugInfo)
        {
            ...
            txtAuditCode.CardColumn = "DrugID|编码|55,ChemName|化学名称|120,BatchNO|批次|70,Spec|规格|120,ProductName|生产厂家|120,PackUnit|单位|40";
        ...
        private void btnCheck_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MessageBox.Show("您确认要审核盘点的单据吗?", "审核提示", MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == DialogResult.OK)
                {
