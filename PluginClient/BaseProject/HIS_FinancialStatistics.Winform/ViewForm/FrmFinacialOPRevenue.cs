...
{
    public partial class FrmFinacialOPRevenue : BaseFormBusiness, IFrmFinacialOPRevenue
    {
        /// <summary>
        /// 报表控件
        /// </summary>
        ...
        /// <summary>
        /// 构造
        /// Initializes a new instance of the<see cref="FrmFinacialOPRevenue" /> class.
        /// </summary>
        public FrmFinacialOPRevenue()
        {
            InitializeComponent();
        }
        ...
        private void FrmFinacialOPRevenue_OpenWindowBefore(object sender, EventArgs e)
        {
        ...
        {
            //0开方医生1开方科室2执行科室3开方科室 + 开方医生4病人类型
        ...
        /// <param name="sender">控件对象</param>
        /// <param name="e">事件参数</param>
        private void FrmFinacialOPRevenue_FormClosed(object sender, FormClosedEventArgs e)
        {
            GridViewResult.Stop();
        }
        ...
        {
            if (cmbRowGroupType.SelectedIndex < 4)
            {
