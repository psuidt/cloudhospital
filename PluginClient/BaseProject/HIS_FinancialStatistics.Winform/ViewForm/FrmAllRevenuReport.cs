...
{
    public partial class FrmAllRevenuReport : BaseFormBusiness, IFrmAllRevenuReport
    {
        /// <summary>
        /// 构造
        /// Initializes a new instance of the <see cref="FrmAllRevenuReport" /> class.
        /// </summary>
        public FrmAllRevenuReport()
        {
            InitializeComponent();
        }
        ...
        private void FrmAllRevenuReport_OpenWindowBefore(object sender, EventArgs e)
        {
            ...
            string reportPath = (string)InvokeController("GetRevenueReportPath");
