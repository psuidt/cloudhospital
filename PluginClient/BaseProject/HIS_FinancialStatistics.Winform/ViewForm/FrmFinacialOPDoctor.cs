...
{
    public partial class FrmFinacialOPDoctor : BaseFormBusiness, IFrmFinacialOPDoctor
    {
        /// <summary>
        /// 构造
        /// Initializes a new instance of the<see cref="FrmFinacialOPDoctor" /> class.
        /// </summary>
        public FrmFinacialOPDoctor()
        {
            InitializeComponent();
        }
        ...
        private void FrmFinacialDoctor_OpenWindowBefore(object sender, EventArgs e)
        {
        ...
        /// <param name="sender">控件对象</param>
        /// <param name="e">事件参数</param>
        private void FrmFinacialDoctor_FormClosed(object sender, FormClosedEventArgs e)
        {
            GridViewResult.Stop();
        }
    }
