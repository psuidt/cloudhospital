...
{
    public partial class FrmQueryHisRecords : BaseFormBusiness, IFrmQueryHisRecords
    {
        #region 属性
        /// <summary>
        /// 复制标志
        ...
        /// 绘制组线
        /// </summary>
        /// <param name="groupFlag">组标识</param>
        /// <param name="graphics">画图图面</param>
