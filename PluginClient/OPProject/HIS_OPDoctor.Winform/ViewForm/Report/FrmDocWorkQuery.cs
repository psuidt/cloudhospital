...
namespace HIS_OPDoctor.Winform.ViewForm
{
    ...
    /// 门诊医生工作量统计
    /// </summary>
    public partial class FrmDocWorkQuery : BaseFormBusiness, IFrmDocWorkQuery
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public FrmDocWorkQuery()
        {
            InitializeComponent();
        }
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dtReport = (DataTable)InvokeController("GetOPDoctorWorkLoad", bdate, edate);
