...
{
    public partial class FrmPesTemplateInfo : BaseFormBusiness, IFrmPesTemplateInfo
    {    
        /// <summary>
        /// 处方模板头
        /// </summary>
        ...
        /// <param name="sender">控件对象</param>
        /// <param name="e">事件参数</param>
        private void FrmPesTemplateInfo_Load(object sender, EventArgs e)
        {
            if (IsNewFlag == true)
            {
                cbNode.Enabled = true;
