...
namespace HIS_OPDoctor.Winform.Controller
{
    ...
    /// 查看历史诊疗记录控制器
    /// </summary>
    [WinformController(DefaultViewName = "FrmQueryHisRecord")]//与系统菜单对应
    [WinformView(Name = "FrmQueryHisRecord", DllName = "HIS_OPDoctor.Winform.dll", ViewTypeName = "HIS_OPDoctor.Winform.ViewForm.FrmQueryHisRecord")]
    public class QueryHisRecordController : WcfClientController
    {
        /// <summary>
        /// 会员id
        /// </summary>
        ...
        /// 历史诊疗记录窗体
        /// </summary>
        IFrmQueryHisRecord iFrmQueryHisRecord;
        ...
        {
            iFrmQueryHisRecord = (IFrmQueryHisRecord)iBaseView["FrmQueryHisRecord"];
        }
        ...
        /// <param name="dtCurrentPatient">当前病人数据</param>
        /// <param name="presDeptId">处方科室id</param>
        /// <returns>窗体返回状态</returns>
        [WinformMethod]
